    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <MetricCard
            title="Custo/KM"
            value={`R$ ${avgCostPerKm.toFixed(2)}`}
            description="Custo médio por quilômetro"
            icon={DollarSign}
            variant="default"
          />
          <MetricCard
      ...
      <Card>
        <CardHeader>
          <CardTitle>Composição dos Custos (Média por Viagem)</CardTitle>
          <CardDescription>Detalhamento dos componentes de custo</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="space-y-2">
              ...
              <div className="w-full bg-secondary h-2 rounded-full overflow-hidden">
                <div 
                  ...
                  style={{ width: `${(avgFuelCost / (avgFuelCost + avgVariableCost + avgTollCost + avgFixedCost)) * 100}%` }}
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="w-full bg-secondary h-2 rounded-full overflow-hidden">
                <div 
                  ...
                  style={{ width: `${(avgVariableCost / (avgFuelCost + avgVariableCost + avgTollCost + avgFixedCost)) * 100}%` }}
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="w-full bg-secondary h-2 rounded-full overflow-hidden">
                <div 
                  ...
                  style={{ width: `${(avgTollCost / (avgFuelCost + avgVariableCost + avgTollCost + avgFixedCost)) * 100}%` }}
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <span className="text-sm font-medium">Custos Fixos Rateados</span>
                <span className="text-sm font-bold">R$ {avgFixedCost.toFixed(2)}</span>
              </div>
              <div className="w-full bg-secondary h-2 rounded-full overflow-hidden">
                <div 
                  className="h-full bg-purple-500" 
                  style={{ width: `${(avgFixedCost / (avgFuelCost + avgVariableCost + avgTollCost + avgFixedCost)) * 100}%` }}
                />
              </div>
            </div>
          </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Análise de rentabilidade de cada rota (ordenado por margem)</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
